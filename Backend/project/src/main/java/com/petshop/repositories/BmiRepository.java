...
public interface BmiRepository extends JpaRepository<Bmi,Long> {
    @Query("select com.petshop.model.dto.response.BmiResponse(b.weight,b.height,b.age,b.gender,b.user.user_id) from Bmi b inner join b.user u where u.user_id = :user_id")
